...
// Tdlist-branded auth page with custom background + logo
// Place assets in public/lovable-uploads/ as below
// Use external image as background (direct Imgur link)
const BG_URL = "https://via.placeholder.com/800x600"; // or replace with /lovable-uploads/tdlist-bg.jpg
const LOGO_URL = "https://via.placeholder.com/150"; // use the smaller image as logo
      ...
      <Card className="w-full max-w-md bg-black/10 border-white/10 shadow-white-glow relative z-10">
        <CardHeader className="text-center space-y-6">
          <div className="flex items-center justify-center">
            ...
            <img src={LOGO_URL} alt="Tdlist" className="h-24 w-auto" />
          </div>
        </CardHeader>
